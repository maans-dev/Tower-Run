 ...
 * --------------------------
 **
 * DIGGER game controls (DropJoystick and ScreenControls)
 */
export const buttons:GamepadControls[] & DropJoystickControls[] = [
    {
        ...
        'hexColour' : 0xff0000,
        'pressFunction': (dosGame) => dosGame.pressKey(AsciiMapping.F1, true),
        'releaseFunction': (dosGame) => dosGame.pressKey(AsciiMapping.F1, false),
